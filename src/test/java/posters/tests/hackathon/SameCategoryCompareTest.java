...
public class SameCategoryCompareTest extends AbstractTest
{
    @Test
    public void testBrowsing() throws IOException
    {
        ...
        File referenceChrome = new File("chromeScreenshot/category-page-reference-" + Neodymium.getBrowserProfileName().replace("Firefox_", "Chrome_")
                                        + ".png");
        File referenceFirefox = new File("firefoxScreenshot/category-page-reference-" + Neodymium.getBrowserProfileName().replace("Chrome_", "Firefox_")
                                         + ".png");
