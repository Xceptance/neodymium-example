...
public class SameCategoryCompareTest extends AbstractTest
{
    ...
    public void testBrowsing() throws IOException
    {
        ...
        File referenceChrome = new File("chromeScreenshot/category-page-reference-" + Neodymium.getBrowserProfileName() + ".png");
        File referenceFirefox = new File("firefoxScreenshot/category-page-reference-" + Neodymium.getBrowserProfileName() + ".png");
