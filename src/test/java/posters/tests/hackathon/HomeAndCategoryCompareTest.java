...
public class HomeAndCategoryCompareTest extends AbstractTest
{
    @Test
    public void testBrowsing() throws IOException
    {
        ...
        File referenceChrome = new File("chromeScreenshot/home-page-reference-" + Neodymium.getBrowserProfileName().replace("Firefox_", "Chrome_") + ".png");
        File referenceFirefox = new File("firefoxScreenshot/home-page-reference-" + Neodymium.getBrowserProfileName().replace("Chrome_", "Firefox_") + ".png");
