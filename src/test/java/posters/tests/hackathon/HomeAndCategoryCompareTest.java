...
public class HomeAndCategoryCompareTest extends AbstractTest
{
    ...
    public void testBrowsing() throws IOException
    {
        ...
        File referenceChrome = new File("chromeScreenshot/home-page-reference-" + Neodymium.getBrowserProfileName() + ".png");
        File referenceFirefox = new File("firefoxScreenshot/home-page-reference-" + Neodymium.getBrowserProfileName() + ".png");
