...
public class PlaceOrderPage extends AbstractCheckoutPage
{
    ...
    public void validatePriceSummary(String shippingCosts)
    {
        // calculate subtotal
        String calculatedSubtotal = calculateSubtotal();
        ...
        // validate subtotal
        subtotalContainer.shouldHave(exactText(calculatedSubtotal));

        // validate shipping costs
        $("#shipping-costs").shouldHave(exactText(shippingCosts));

        // validate tax
        taxContainer.shouldHave(exactText(PriceHelper.calculateTax(shippingCosts, calculatedSubtotal)));

        // validate grand total
        orderTotal.shouldHave(exactText(PriceHelper.calculateGrandTotal(calculatedSubtotal, shippingCosts, getTax())));
    }
