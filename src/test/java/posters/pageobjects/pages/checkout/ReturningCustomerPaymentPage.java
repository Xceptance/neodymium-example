    ...
    public void validateCreditCardContainer(CreditCard creditCard)
    {
        ...
        final SelenideElement creditCardContainer = $$(".thumbnail").shouldHave(sizeGreaterThan(0))
                                                                    .findBy(new WebElementCondition(
                                                                        "has full name " + creditCard.getFullName() + ", card number " + creditCard.getCrypticCardNumber()
                                                                            + ", expire date " + creditCard.getExpDate())
                                                                    {
                                                                        ...
                                                                        public CheckResult check(Driver driver, WebElement element)
                                                                        {
                                                                            ...
                                                                            boolean matchesCreditCard = element.findElement(By.cssSelector(".creditcard"))
                                                                                                               .getText()
